...
<div class="container mx-auto py-8">
    ...
    <form action="{{ route('services.update', $service) }}" method="POST" class="max-w-lg bg-white shadow rounded-lg p-6">
        @csrf
        @method('PUT')
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <textarea name="description" id="description" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ old('description', $service->description) }}</textarea>
        ...
        <div class="mb-4">
            ...
            <input type="number" name="price" id="price" step="0.01" min="0" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('price', $service->price) }}" required>
